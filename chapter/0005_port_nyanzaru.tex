...
% Illustration à ajouter lorsque l'image définitive sera disponible.
% \illustration[0.9\textwidth]{2026-09-15/carte-port-nyanzaru.png}
% {\textit{Port Nyanzaru, unique cité de Chult.}}
% {carte_port_nyanzaru}
...
% Illustration à ajouter lorsque l'image définitive sera disponible.
% \illustration[0.45\textwidth]{2026-09-15/Wakanga_Otamu.png}
...
% Illustration à ajouter lorsque l'image définitive sera disponible.
% \illustration[0.45\textwidth]{2026-09-15/Syndra.png}
% {\textit{Syndra, l'amie de longue date de Wakanga.}}
% {syndra}
...
% Illustration à ajouter lorsque l'image définitive sera disponible.
% \illustration[0.95\textwidth]{2026-09-15/carte-chult.png}
% {\textit{La carte de Chult remise au groupe par Wakanga. Les régions grisées restent inexplorées ; chaque hexagone représente environ quinze kilomètres.}}
% {carte_chult}
